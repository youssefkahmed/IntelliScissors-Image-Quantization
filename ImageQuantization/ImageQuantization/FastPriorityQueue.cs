...
namespace ImageQuantization
{
    ...
    class FastPriorityQueueNode
    {
        ...
        /// </summary>
        public float currentWeight { get; protected internal set; }
    ...
    class FastPriorityQueue<T> : IFixedSizePriorityQueue<T, float>
        where T : FastPriorityQueueNode
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        #endif
        public void Enqueue(T node, float currentWeight)
        {
            #if DEBUG
            if(node == null)
            {
        ...
        {
            return (higher.currentWeight < lower.currentWeight);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        #endif
        public void UpdatePriority(T node, float currentWeight)
        {
            #if DEBUG
            if(node == null)
            {
